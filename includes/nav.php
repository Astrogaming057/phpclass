<a class="nav-link<?php echo (!empty($currentPage) && $currentPage === 'home') ? ' is-active' : ''; ?>" href="/index.php">Home</a>
<a class="nav-link<?php echo (!empty($currentPage) && $currentPage === 'loops') ? ' is-active' : ''; ?>" href="/loops/">Loops</a>
